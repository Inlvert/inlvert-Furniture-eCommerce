...
export default function Navbar() {
  ...
  return (
    <header className="max-w-[1440px] bg-white shadow-md w-full z-50 text-black h-[100px] flex items-center justify-center">
      <div className="max-w-8xl mx-auto px-8 sm:px-12 lg:px-16 flex justify-between items-center w-full">
        ...
        <nav className="hidden md:flex space-x-6">
          ...
          {/* <Link href="/compare" className="hover:font-bold transition">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
